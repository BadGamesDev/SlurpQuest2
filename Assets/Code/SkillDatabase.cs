...
public class SkillDatabase : MonoBehaviour //got forced me to put this shit in the editor to humble me for not learning all the global shit properly
{
    ...
    public static Skill finalForm = new() { skillName = "Final Form", skillDesc = "Slurp ascends into her final form! She can pick one of her three alter egos: Thoswis, Clownwis, or Tradwis. Thotwis charms a random non-boss enemy each turn, Tradwis heals her whole team each turn, Clownwis just doesn't fucking care and gives everyone random status effects each turn." , hostile = false };
